...
```{r}
load(file = "./haoran/saved_results/cnnet.rda") 
load(file = "./haoran/saved_results/boost.rda")
load(file = "./haoran/saved_results/rf.rda")
load(file = "./haoran/saved_results/bagging.rda")
load(file = "./haoran/saved_results/bayes.rda")
load(file = "./haoran/saved_results/svmr.rda")
